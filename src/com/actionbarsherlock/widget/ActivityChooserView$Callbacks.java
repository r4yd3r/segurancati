    ...
    implements android.widget.r, android.view.ner, android.view.ner, android.widget.r
{
    ...
    public void onClick(View view)
    {
        ...
        {
            dismissPopup();
            android.content.pm.ResolveInfo resolveinfo = ActivityChooserView.access$0(ActivityChooserView.this).getDefaultActivity();
            int i = ActivityChooserView.access$0(ActivityChooserView.this).getDataModel().getActivityIndex(resolveinfo);
            android.content.Intent intent = ActivityChooserView.access$0(ActivityChooserView.this).getDataModel().chooseActivity(i);
            if (intent != null)
            {
                ActivityChooserView.access$4(ActivityChooserView.this).startActivity(intent);
            }
            return;
        }
...
_L4:
        ...
        intent = ActivityChooserView.access$0(ActivityChooserView.this).getDataModel().chooseActivity(i);
        if (intent != null)
        {
            ActivityChooserView.access$4(ActivityChooserView.this).startActivity(intent);
            return;
